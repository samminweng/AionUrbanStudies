...
function DocView(doc, selected_terms, occ_terms) {
    ...
    function _createUI() {
        ...
        title_div = mark_key_terms(title_div, occ_terms, 'key_phrase');
        title_div = mark_key_terms(title_div, selected_terms, 'search_terms');
        ...
        abstract_div = mark_key_terms(abstract_div, occ_terms, 'key_phrase');
        abstract_div = mark_key_terms(abstract_div, selected_terms, 'search_terms');
