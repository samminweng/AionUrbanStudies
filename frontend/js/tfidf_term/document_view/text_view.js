// Create a title view
function TextView(document, searched_terms){
    // console.log(document);
    const key_terms = document['KeyTerms'].filter(term => !searched_terms.includes(term)).slice(0, 5);
    ...
    function _createUI(){
        ...
        title_div = mark_key_terms(title_div, searched_terms, 'search_term');
        ...
        abstract_div = mark_key_terms(abstract_div, searched_terms, 'search_term');
        ...
        author_keyword_div = mark_key_terms(author_keyword_div, searched_terms, 'search_term');
