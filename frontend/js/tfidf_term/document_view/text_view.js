...
function TextView(document, searched_term, complementary_terms) {
    ...
    function _createUI() {
        ...
        title_div = mark_key_terms(title_div, [searched_term], 'lead search_term');
        title_div = mark_key_terms(title_div, complementary_terms, 'lead complementary_term');
        ...
        abstract_div = mark_key_terms(abstract_div, [searched_term], 'lead search_term');
        abstract_div = mark_key_terms(abstract_div, complementary_terms, 'lead complementary_term');
        ...
        author_keyword_div = mark_key_terms(author_keyword_div, [searched_term], 'lead search_term');
        author_keyword_div = mark_key_terms(author_keyword_div, complementary_terms, 'lead complementary_term');
