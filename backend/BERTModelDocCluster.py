...
class BERTModelDocCluster:
    def __init__(self, iteration):
        ...
        folder = os.path.join('output', self.args.case_name, 'cluster', self.args.iteration, 'doc_vectors')
    ...
    def get_sentence_vectors(self, text_df, iteration='iteration_0'):
        ...
        folder = os.path.join('output', self.args.case_name, 'cluster', iteration, 'doc_vectors')
    ...
    def re_cluster_outliers_by_hdbscan(self):
        try:
            ...
            outlier_df['Text'] = outlier_df['Title'] + ". " + outlier_df['Abstract']
            self.get_sentence_vectors(outlier_df, next_iteration)
        except Exception as err:
            print("Error occurred! {err}".format(err=err))
